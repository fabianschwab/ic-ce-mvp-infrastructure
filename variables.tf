...
variable "container_registry_name" {
  type        = string
  description = "Container registry namespace name which holds the images for the applications. The name has a random 8 character suffix to avoid name collisions."
  default     = "mvp-images"
}
